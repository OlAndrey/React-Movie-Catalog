...
const Registry: React.FunctionComponent<IRegistry> = ({nameInputError, emailInputError, passwordInputError, handleForm, clearError, handleClose})  => {
    ...
    return (
        <>
            <DialogTitle id="form-dialog-title" textAlign="center">Registration</DialogTitle>
            <DialogContent>
                <TextField 
                    autoFocus
                    margin="dense"
            ...
            <DialogActions>
                ...
                <Button onClick={() => handleForm(emailInput, passwordInput, nameInput)} variant="contained">Registry</Button>
            </DialogActions>
        </>
    )
}
