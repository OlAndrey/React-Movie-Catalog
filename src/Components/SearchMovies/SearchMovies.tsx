...
const SearchMovies: React.FC<SearchMoviesPropsType> = ({
  isLoading,
  isError,
  searchMovies,
  setSearchList,
  ...
  }, [movieName, setSearchList]);

  return (
    <Container sx={{ margin: '4.2em auto 0 auto', flexGrow: 1 }}>
      <Typography variant="h3" component="h2" textAlign="center" margin=".5em 0">
        Result search: {movieName}
      </Typography>
      {isLoading ? <Loader /> : <MovieList movies={searchMovies} />}
    </Container>
  );
};
